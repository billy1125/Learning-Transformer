...
>
> **前置文件：** [`04-gpt-decoder-only.md`](04-gpt-decoder-only.md)（原理與數學）、[`04b-nanogpt-walkthrough.md`](04b-nanogpt-walkthrough.md)（nanoGPT 程式對照）、[`05-backpropagation.md`](05-backpropagation.md)（§1 的梯度對比會用到）
>
