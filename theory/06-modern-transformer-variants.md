...
>
> **前置文件：** [`04a-gpt-decoder-only.md`](04a-gpt-decoder-only.md)（基本概念與 Pipeline）、[`05a1-forward-propagation.md`](05a1-forward-propagation.md)（前向數學）、[`04b-nanogpt-walkthrough.md`](04b-nanogpt-walkthrough.md)（nanoGPT 程式對照）、[`05b1-backward-propagation.md`](05b1-backward-propagation.md)（本文 §1 的梯度對比會用到，對應該文 §5）
>
